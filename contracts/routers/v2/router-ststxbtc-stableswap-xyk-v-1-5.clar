;; router-ststxbtc-stableswap-xyk-v-1-5
...
(define-public (get-quote-a
  ...
  (let (
    (quote-a (if (is-eq ststx-ststxbtc-calls-reversed false)
      ...
      (try! (contract-call? .router-stableswap-xyk-v-1-5 get-quote-a
...
(define-public (swap-helper-a
  ...
  (let (
    (swap-a (if (is-eq ststx-ststxbtc-calls-reversed false)
      ...
      (try! (contract-call? .router-stableswap-xyk-v-1-5 swap-helper-a
