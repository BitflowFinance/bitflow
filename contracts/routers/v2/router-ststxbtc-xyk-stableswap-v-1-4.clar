...
(define-public (get-quote-a
  ...
  (let (
    (quote-a (if (is-eq ststx-ststxbtc-calls-reversed false)
      ...
      (try! (contract-call? .router-xyk-stableswap-v-1-4 get-quote-a
            amount provider swaps-reversed xyk-tokens xyk-pools stableswap-tokens stableswap-pools))
    ))
    (quote-b (if (is-eq ststx-ststxbtc-calls-reversed false)
      (try! (contract-call? .router-xyk-stableswap-v-1-4 get-quote-a
            quote-a provider swaps-reversed xyk-tokens xyk-pools stableswap-tokens stableswap-pools))
...
(define-public (swap-helper-a
  ...
  (let (
    (swap-a (if (is-eq ststx-ststxbtc-calls-reversed false)
      ...
      (try! (contract-call? .router-xyk-stableswap-v-1-4 swap-helper-a
